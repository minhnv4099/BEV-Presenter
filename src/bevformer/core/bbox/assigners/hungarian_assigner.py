...
class HungarianAssigner(BaseAssigner):
    ...
    Args:
        match_costs (:obj:`dict` or  List[Union[:obj:`ConfigDict`, dict]]): Match cost configs.
    """

    def __init__(self, match_costs: List[ConfigType]) -> None:
        ...
        self.match_costs = [
            build_match_cost(match_cost) for match_cost in match_costs
        ]
