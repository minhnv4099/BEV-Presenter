...
class NMSFreeCoder:
    ...
    Args:
        pc_range (Sequence[float]): Range of point cloud.
        post_center_range (Sequence[float]): Limit of the center.
            Default: None.
    ...
    def decode_single(self, cls_scores: torch.Tensor, bbox_preds: torch.Tensor):
        """Decode bboxes.
        Args:
